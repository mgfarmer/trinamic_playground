...
{
	ACCESS_WRITE,  // 0: DRVCTRL
	ACCESS_NONE,   // 1: UNUSED
	ACCESS_NONE,   // 2: UNUSED
	ACCESS_NONE,   // 3: UNUSED
	ACCESS_WRITE,  // 4: CHOPCONF
	ACCESS_WRITE,  // 5: SMARTEN
	ACCESS_WRITE,  // 6: SGCSCONF
	ACCESS_WRITE   // 7: DRVCONF
};
...
{ // refreshes settings to prevent chip from loosing settings on brownout
	...
	write = (write == TMC2660_DRVCTRL) ? TMC2660_CHOPCONF : ((write + 1) % REGISTER_COUNT);
}
