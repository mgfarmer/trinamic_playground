#ifndef TMC5062_REGISTER_H
#define TMC5062_REGISTER_H

	// ===== TMC5062 register set =====
	...
	#define TMC5062_DRVSTATUS(motor)   (0x6F|MOTOR_ADDR_DRV(motor))  //      0x6F            0x7F
