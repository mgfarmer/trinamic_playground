...
void initMotorParams(int motor) {
...
void gotoTarget(int motor, int targetPos, int wait) {
...
int getPosition(int motor) {
	return tmc5160_readInt(MOTOR0, TMC5160_XACTUAL);
}
